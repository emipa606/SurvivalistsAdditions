...
public class SrvSettings : ModSettings
{
    ...
    public static int VinegarBarrel_FermentTicks => GenDate.TicksPerDay * VinegarBarrel_FermentDays;

    public static int CheeseBarrel_AgingTicks => GenDate.TicksPerDay * CheeseBarrel_AgingDays;

    public static int Smoker_SmokeTicks => GenDate.TicksPerHour * Smoker_SmokeHours;

    public static int Smoker_TendTicks => GenDate.TicksPerHour * Smoker_TendHours;

    public static int CharcoalPit_BurnTicks => GenDate.TicksPerHour * CharcoalPit_BurnHours;
